export default function Test() {
  return (
    <div
      id="contacts"
      className="grid laptop:grid-cols-2 grid-cols-1 h-screen  w-auto  bg-rose-700  "
    >
      <div className="bg-gray-200 mr-[3px]  flex justify-center items-center">
        <div className="laptop:text-4xl text-xl font-extrabold text-gray-900">
          Whatsapp
          <br />
          <span className="laptop:text-2xl text-gray-700">
      ...
      <div className="bg-gray-900 ml-[3px]  flex justify-center items-center">
        ...
        <div className="laptop:text-4xl text-xl font-extrabold text-gray-200 m-12">
          Email Address
          <br />
          <span className="laptop:text-2xl text-gray-300">
            Tap To Launch Email App
          </span>
        </div>
      </div>
    </div>
